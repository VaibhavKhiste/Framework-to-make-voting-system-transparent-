				...
				<table class="table">
					<thead>
						<tr>
							...
							<th style="text-align: center" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PARTY SYMBOL</th>
					...
					<tbody>
						<tr>
							...
							<tr>
								...
								<td><br/><input type="button" name="submit" id="submitnew" value="submit" style="border: 2px solid steelblue; width: 10%;height:50px;background-color: steelblue;color: white" /></td>
