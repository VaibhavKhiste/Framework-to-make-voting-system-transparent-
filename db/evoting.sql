...
(1, 'Gummidipoondi', 'THIRUVALLUR (SC)', 'Gummidipoondi', 'Gummidipoondi'),
(2, 'Ponneri', 'THIRUVALLUR (SC)', 'Ponneri (SC)', 'Ponneri (SC)'),
(3, 'Thiruvallur ', 'THIRUVALLUR (SC)', 'Thiruvallur ', 'Thiruvallur '),
(4, 'Poonamallee', 'THIRUVALLUR (SC)', 'Poonamallee (SC)', 'Poonamallee (SC)'),
(5, 'Avadi', 'THIRUVALLUR (SC)', 'Avadi', 'Avadi'),
(6, 'Madavaram', 'THIRUVALLUR (SC)', 'Madavaram', 'Madavaram'),
(7, 'Tiruvottiyur', 'CHENNAI NORTH', 'Tiruvottiyur', 'Tiruvottiyur'),
(8, 'Dr.Radhakrishnan Nagar', 'CHENNAI NORTH', 'Dr.Radhakrishnan Nagar', 'Dr.Radhakrishnan Nagar'),
(9, 'Perambur', 'CHENNAI NORTH', 'Perambur', 'Perambur'),
(10, 'Kolathur ', 'CHENNAI NORTH', 'Kolathur ', 'Kolathur '),
(11, 'Thiru -Vi -Ka -Nagar', 'CHENNAI NORTH', 'Thiru -Vi -Ka -Nagar (SC)', 'Thiru -Vi -Ka -Nagar (SC)'),
(12, 'Royapuram', 'CHENNAI NORTH', 'Royapuram', 'Royapuram'),
(13, 'Virugampakkam', 'CHENNAI SOUTH', 'Virugampakkam', 'Virugampakkam'),
(14, 'Saidapet', 'CHENNAI SOUTH', 'Saidapet', 'Saidapet'),
(15, 'Thiyagarayanagar', 'CHENNAI SOUTH', 'Thiyagarayanagar', 'Thiyagarayanagar'),
(16, 'Mylapore', 'CHENNAI SOUTH', 'Mylapore', 'Mylapore'),
(17, 'Velachery', 'CHENNAI SOUTH', 'Velachery', 'Velachery'),
(18, 'Sholinganallur', 'CHENNAI SOUTH', 'Sholinganallur', 'Sholinganallur'),
(19, 'Villivakkam', 'CHENNAI CENTRAL', 'Villivakkam', 'Villivakkam'),
(20, 'Egmore', 'CHENNAI CENTRAL', 'Egmore (SC)', 'Egmore (SC)'),
(21, 'Harbour ', 'CHENNAI CENTRAL', 'Harbour ', 'Harbour '),
(22, 'Chepauk-Thiruvallikeni', 'CHENNAI CENTRAL', 'Chepauk-Thiruvallikeni', 'Chepauk-Thiruvallikeni'),
(23, 'Thousand Lights', 'CHENNAI CENTRAL', 'Thousand Lights', 'Thousand Lights'),
(24, 'Anna Nagar', 'CHENNAI CENTRAL', 'Anna Nagar', 'Anna Nagar'),
(25, 'Maduravoyal', 'SRIPERUMBUDUR', 'Maduravoyal', 'Maduravoyal'),
(26, 'Ambattur', 'SRIPERUMBUDUR', 'Ambattur', 'Ambattur'),
(27, 'Alandur', 'SRIPERUMBUDUR', 'Alandur', 'Alandur'),
(28, 'Sriperumbudur', 'SRIPERUMBUDUR', 'Sriperumbudur (SC)', 'Sriperumbudur (SC)'),
(29, 'Pallavaram', 'SRIPERUMBUDUR', 'Pallavaram', 'Pallavaram'),
(30, 'Tambaram', 'SRIPERUMBUDUR', 'Tambaram', 'Tambaram'),
(31, 'Chengalpattu', 'KANCHEEPURAM (SC)', 'Chengalpattu', 'Chengalpattu'),
(32, 'Thiruporur', 'KANCHEEPURAM (SC)', 'Thiruporur', 'Thiruporur'),
(33, 'Cheyyur ', 'KANCHEEPURAM (SC)', 'Cheyyur (SC)', 'Cheyyur (SC)'),
